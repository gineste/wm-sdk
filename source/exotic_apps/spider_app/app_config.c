...
#define DEFAULT_TEMPERATURE_EN    false
#define DEFAULT_HUMIDITY_EN       false
#define DEFAULT_PRESSURE_EN       false
#define DEFAULT_ACCEL_X_EN        false
#define DEFAULT_ACCEL_Y_EN        false
#define DEFAULT_ACCEL_Z_EN        false
#define DEFAULT_SENSORS_PERIOD_MS (30*1000)
