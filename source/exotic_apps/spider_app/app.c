...
void App_init(const app_global_functions_t * functions)
{
  ...
  //  ruuvi_spi_init();
   ...
   // LIS2DH12_wrapper_init();
     ...
     nrf_gpio_pin_dir_set(BOARD_POWER_VSEL, NRF_GPIO_PIN_DIR_OUTPUT);
     nrf_gpio_cfg_output(BOARD_POWER_VSEL);
     nrf_gpio_pin_clear(BOARD_POWER_VSEL);

    //  nrf_gpio_pin_dir_set(BOARD_CHL, NRF_GPIO_PIN_DIR_OUTPUT);
    //  nrf_gpio_cfg_output(BOARD_CHL);
    //  nrf_gpio_pin_set(BOARD_CHL);
     
    //  nrf_gpio_pin_dir_set(BOARD_CSD, NRF_GPIO_PIN_DIR_OUTPUT);
    //  nrf_gpio_cfg_output(BOARD_CSD);
    //  nrf_gpio_pin_set(BOARD_CSD);

    //  nrf_gpio_pin_dir_set(BOARD_CTX, NRF_GPIO_PIN_DIR_OUTPUT);
    //  nrf_gpio_cfg_output(BOARD_CTX);
    //  nrf_gpio_pin_set(BOARD_CTX);

    //  nrf_gpio_pin_dir_set(BOARD_CPS, NRF_GPIO_PIN_DIR_OUTPUT);
    //  nrf_gpio_cfg_output(BOARD_CPS);
    //  nrf_gpio_pin_clear(BOARD_CPS);
